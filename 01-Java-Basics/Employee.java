//Write a Java program to declare employee details using different data types and display them using a method.
...
public class Employee {
	...
	void display() {
		...
		// Deducting one leave before displaying the current balance
		Numberofleaves--;
